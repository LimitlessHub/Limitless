...
const ServicePage = () => {
  ...
  // FIX: This is the correct logical order. The RTL direction will handle the visual order automatically.
  const pageTabs = [
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
          <main className="lg:col-span-2">
            ...
            {/* FIX: ServiceFeatures is now separate from the tabs and will not be repeated. */}
            <ServiceFeatures />
          </main>
